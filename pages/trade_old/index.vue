...
.row
  .col.trade-page
    ...
    client-only
      DesktopTradeOld(v-if="!isMobile")
      MobileTradeOld(v-else)
      nuxt-child
</template>
...
import DesktopTradeOld from '~/components/trade/DesktopTradeOld'
import MobileTradeOld from '~/components/trade/MobileTradeOld'
