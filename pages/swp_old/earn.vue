<template lang="pug">
.earn
  h3.label {{ $t('My Deposits') }}
  el-radio-group.custom-radio(size="small")
    el-radio-button(:label="$t('All Type')")
    el-radio-button(:label="$t('Liquidity Pools')")
    el-radio-button(:label="$t('Liquidity mining')")
    el-radio-button(:label="$t('Staking')")
  ...
  //-   style='width: 100%',
  //- )
  //-   el-table-column(:label='$t("Pair")', prop='date', :width='isMobile ? 150 : 280')
