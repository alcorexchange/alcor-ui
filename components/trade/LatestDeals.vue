...
.max-buymatch {
  background: linear-gradient(180deg, var(--color-primary-op) 0%, rgba(192, 219, 178, 0.2) 100%);
}

.max-sellmatch {
  background: linear-gradient(180deg, var(--color-secondary-op) 0%, rgba(255, 0, 0, 0.2) 100%);
}
