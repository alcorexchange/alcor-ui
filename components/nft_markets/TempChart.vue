      ...
      const widgetOptions = {
        ...
        datafeed: {
          ...
          resolveSymbol: (
            ...
            const symbolInfo = {
              name: this.quote_token_symbol_name,
              //description: `${this.quote_token_symbol_name}/${this.base_token.symbol.name}`,
              //description: `${this.quote_token_symbol_name}/${this.base_token.symbol.name}`,
          ...
          getBars: async (
            ...
            this.widget.activeChart().setSymbol(this.quote_token_symbol_name)
          },
